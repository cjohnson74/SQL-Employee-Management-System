...
class DB {
  ...
  updateEmployeeDepartment(employeeId, departmentId) {
    return this.connection.promise().query("UPDATE employee SET department_id = ? WHERE id = ?", [departmentId, employeeId]);
  }
  ...
  removeDepartment(departmentId) {
    return this.connection.promise().query("DELETE FROM role WHERE id = ?", departmentId);
  }
}
